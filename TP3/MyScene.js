...
class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.cube = new MyUnitCube(this,8);
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.25,0.15,0.15,1.0);
        this.material4.setDiffuse(0.25,0.15,0.15,1.0);
        this.material4.setSpecular(0.25,0.15,0.15,0.3);
